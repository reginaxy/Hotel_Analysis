...
def main():
    ...
    if page == "Homepage":
        ...
        customer contentment, and customer loyalty are not overlooked. Aside, many more could be discovered and spotted upon a comprehensive review analysis.") 
        ...
        image = Image.open("streamlit_template/Analytics Process.png")
        ...
        st.markdown('<iframe title="Hotel (Web version) plus" width="1024" height="612" src="https://app.powerbi.com/view?r=eyJrIjoiOGM0NDBlYzEtN2RhZS00YjljLTg2NDMtMDY3YTkyM2QzZDg4IiwidCI6IjBmZWQwM2EzLTQwMmQtNDYzMy1hOGNkLThiMzA4ODIyMjUzZSIsImMiOjEwfQ%3D%3D&embedImagePlaceholder=true&pageName=ReportSection" frameborder="0" allowFullScreen="true"></iframe>', unsafe_allow_html = True)     
